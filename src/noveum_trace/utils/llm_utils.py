...
from noveum_trace.utils.model_registry import (
    MODEL_ALIASES,
    MODEL_REGISTRY,
    ModelInfo,
)
...
# MODEL_REGISTRY and MODEL_ALIASES are now in model_registry.py.
# They are imported above and re-exported so existing call sites are unaffected.
