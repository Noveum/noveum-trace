...
def instrument_openai():
    ...
    try:
        ...
        _original_methods['chat_completions_create'] = openai.resources.chat.completions.Completions.create
        
        # Patch methods
        openai.resources.chat.completions.Completions.create = _wrap_chat_completions_create(
...
def uninstrument_openai():
    ...
    try:
        ...
        if 'chat_completions_create' in _original_methods:
            openai.resources.chat.completions.Completions.create = _original_methods['chat_completions_create']
