...
from noveum_trace.types import SpanKind, SpanStatus, LLMRequest, LLMResponse, OperationType, AISystem
...
class TestSpan:
    ...
    def test_add_link(self):
        ...
        span.add_link("other_span_id", "other_trace_id", {"link_attr": "value"})
