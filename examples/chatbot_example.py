...
class TracedChatbot:
    ...
    def chat(self, session_id: str, message: str) -> str:
        ...
        with noveum_trace.get_tracer().start_span("chat_turn") as turn_span:
            ...
            with noveum_trace.get_tracer().start_span("context_preparation") as context_span:
                context = self._prepare_context(session_id)
                context_span.set_attribute("context.messages_count", len(context))
                context_span.set_attribute("context.total_tokens", self._estimate_tokens(context))
    ...
    def end_session(self, session_id: str) -> Dict[str, Any]:
        ...
        with noveum_trace.get_tracer().start_span("session_end") as span:
            ...
            session_duration = session_data[-1]["timestamp"] - session_data[0]["timestamp"] if session_data else 0
